return {
  ...
  config = function(_, opts)
    ...
    wk.add({
	{ "<leader>e", "<cmd>Neotree toggle reveal<CR>", desc = "File Explorer", icon = { icon = "", color = "blue" }}, 
	...
	-- Telescope (Live Grep)
        ...
        { "<leader>ff", "<cmd>Telescope find_files hidden=true<CR>", desc = "CWD Files", icon = { icon = "", color = "purple" } },
        { "<leader>fF", "<cmd>Telescope find_files cmd=~ hidden=true<CR>", desc = "All Files", icon = { icon = "", color = "purple" } },
	...
	{ "<leader>fg", "<cmd>Telescope git_files<CR>", desc = "Git Files", icon = { icon = "", color = "purple" } },
        { "<leader>fw", "<cmd>Telescope grep_string<CR>", desc = "Word Under Cursor", icon = { icon = "", color = "purple" } },
    })
  end,
}
